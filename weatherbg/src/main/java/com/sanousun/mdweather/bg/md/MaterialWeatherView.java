package com.sanousun.mdweather.bg.md;
...
import com.sanousun.mdweather.bg.R;
import com.sanousun.mdweather.bg.WeatherView;
import com.sanousun.mdweather.bg.md.implementor.CloudImplementor;
import com.sanousun.mdweather.bg.md.implementor.HailImplementor;
import com.sanousun.mdweather.bg.md.implementor.MeteorShowerImplementor;
import com.sanousun.mdweather.bg.md.implementor.RainImplementor;
import com.sanousun.mdweather.bg.md.implementor.SmogImplementor;
import com.sanousun.mdweather.bg.md.implementor.SnowImplementor;
import com.sanousun.mdweather.bg.md.implementor.SunImplementor;
import com.sanousun.mdweather.bg.md.implementor.WindImplementor;
import com.sanousun.mdweather.bg.md.rotate.BaseRotateController;
import com.sanousun.mdweather.bg.md.rotate.DecelerateRotateController;
...
public class MaterialWeatherView extends SurfaceView
    ...
    private void initialize() {
        ...
        if (getResources().getDisplayMetrics().heightPixels - firstCardMarginTop < 214 * density) {
            firstCardMarginTop = (int) (getResources().getDisplayMetrics().heightPixels - 214 * density);
    ...
    public void run() {
        ...
        while (running) {
            ...
            if (implementor != null && rotators != null) {
                ...
                if (step != WeatherView.WEATHER_KING_NULL) {
                    setWeatherImplementor();
                } else {
                    synchronized (surfaceLock) {
                        if (running) {
